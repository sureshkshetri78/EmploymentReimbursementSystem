...
export class ReimbursementByUserComponent extends React.Component<any, any>  {
    ...
    getReimbursementByUser = async () => {
        ...
        try {
            ...
            const response = await fetch('http://localhost:9050/reimbursements/author/userid/' + id, {
                method: 'GET',
                credentials: 'include',
                headers: {
    ...
    render() {
        ...
        return (
            ...
            <br/><br/><h1>Reimbursement by user </h1><br/><br/>
            ...
            <h4 className="center">Find reimbursement by User: {this.state.reimbursements && this.state.reimbursements.reimbursement_id}</h4>
